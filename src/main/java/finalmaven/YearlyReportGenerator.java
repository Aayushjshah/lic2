...
public class YearlyReportGenerator{
    String[] headers = {"Month","PolicyId" , "Holder" , "Premium Amount" , "Due Date" , "Agent" , "Bank Acc"};
	Cell[] cells ;
    YearlyReportGenerator(){}
    public void pdfMaker(String usrnm,String currYr,String[][] values){
        try{
            ...
            String dest = "reports/yearlySample.pdf";
...
//table
            ...
            Text t = new Text("Yearly Premium Report");
           //image
...
//				tt3.set
    ...
    table3.setMarginTop(10f);
     document.add(table3);
    float[] widthVal = {110F,100F,150F,150F,150F,150F,100F};
        ...
        //headers	
            ...
            total += Integer.parseInt(values[j][3]);
        }
//total
    ...
    //     String[][]val = {{"january","1991","Rina","4000","08-08-2021","Divyesh","Boi@Rina"},
    //                       {"january","1991","Rina","4000","08-08-2021","Divyesh","Boi@Rina"},
    //                       {"February","1991","Rina","4000","08-08-2021","Divyesh","Boi@Rina"},
    //                       {"March","1991","Rina","4000","08-08-2021","Divyesh","Boi@Rina"},
    //                       {"March","1991","Rina","4000","08-08-2021","Divyesh","Boi@Rina"},
    //                       {"April","1991","Rina","4000","08-08-2021","Divyesh","Boi@Rina"} };
    //     new YearlyReportGenerator("Manraj","2021",val);
    // }
}
